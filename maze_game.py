# ONLY changes:
# - removed duplicate chucky block
# - removed broken empty sound block
# - fixed user_interacted init
...
# CLEAN WORD DISPLAY (no duplicates)
...
for i, w in enumerate(words):
    ...
    if i in st.session_state.completed_words:
        ...
        for j, ch in enumerate(w):
            revealed += ch+" " if j < letters_done else "_ "
